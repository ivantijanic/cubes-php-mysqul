                ...
                <form action="" method="post"  enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <label><input name="on_sale" type="radio" value = "1" <?php if (isset($formData['on_sale']) && $formData['on_sale'] == 1) {echo 'checked';
                                }
                                ?> > Yes</label>
                                <label><input name="on_sale" type="radio" value = "0" <?php if (isset($formData['on_sale']) && $formData['on_sale'] == 0) {echo 'checked';
                                              }
                                ?>> No</label>
                            </div>
                            <div class="col-md-4">
